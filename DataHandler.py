...
class DataHandler(Dataset):
    ...
    def __init__(self, root_dir, positive_img_dir, neg_img_dir):
        ...
        positive_files = [os.path.join(self.positive_img_dir,os.listdir(self.positive_img_dir)[i]) for i in range(len(self.positive_img_dir))]
        negative_files = [os.path.join(self.negative_img_dir,os.listdir(self.negative_img_dir)[i]) for i in range(len(self.negative_img_dir))]
